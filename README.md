# FreshWeb Testimonials Plugin for the FreshWeb Theme

This hand-coded plugin creates a 'testimonial' post type whereby testimonials can be built and displayed throughout your website.
...
git clone https://freshwebstudio.git.beanstalkapp.com/freshweb-plugin-freshweb-testimonia.git -o beanstalk freshweb-testimonials
cd freshweb-testimonials
...
```
cd /wp-content/plugins/freshweb-testimonials
git init
git remote add beanstalk git@freshwebstudio.beanstalkapp.com:/freshweb-plugin-freshweb-testimonia.git
git add .

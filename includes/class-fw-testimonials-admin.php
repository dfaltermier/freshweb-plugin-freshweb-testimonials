...
class FW_Testimonials_Admin {
    ...
    public function enqueue_scripts() {
         ...
         */
        if ( FW_TESTIMONIALS_POST_TYPE_ID === $typenow ) {

            wp_enqueue_style(
                'fw_testimonials_admin_styles',
                FW_TESTIMONIALS_ADMIN_CSS_URL . '/style.css',
                array(), 
                FW_TESTIMONIALS_VERSION
            );

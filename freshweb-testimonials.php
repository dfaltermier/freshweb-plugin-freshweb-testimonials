 ...
 *
 * Plugin Name:    Freshweb Testimonials
 * Plugin URI:     https://freshwebstudio.beanstalkapp.com
 * Description:    Create and manage testimonials specifically for the FreshWeb theme.
 * Version:        1.0.1
 * Author:         Freshweb Studio
 * Author URI:     https://freshwebstudio.com
 * Text Domain:    freshweb-testimonials
 ...
 */
require plugin_dir_path( __FILE__ ) . 'includes/class-fw-testimonials.php';
 ...
 * @since 0.9.1
 */
function fw_testimonials_activation() {
...
register_activation_hook( __FILE__, 'fw_testimonials_activation' );
 ...
 * @since 0.9.1
 */
function fw_testimonials_deactivation() {
    flush_rewrite_rules();
}
register_deactivation_hook( __FILE__, 'fw_testimonials_deactivation' );
 ...
 * @since 0.9.1
 */
function fw_testimonials_run() {
    $plugin = new FW_Testimonials();
    $plugin->run();
}
